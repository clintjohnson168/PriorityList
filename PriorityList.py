...
class PriorityList:
    ...
    def updateAllRatings(self):
        ...
        for item, values in self.myList.items():
            ...
            rating = float(input("Enter new rating for %s from 1 to 10: " %(item)))
    ...
    def updateOneRating(self):
        ...
        name = input("Enter item for update: ")
        ...
        for item, values in self.myList.items():
            ...
            if item == name:
                ...
                try:
                    rating = float(input("Enter new rating for %s from 1 to 10: " %(name)))
                except:
                    print("No rating was entered.")
                    return
                #calculate new rating
...
def main():
    ...
    while True:
        ...
        if choice == 1:
            ...
            rating = float(input("Enter Rating from 1 to 10: "))
            #add item to myList
